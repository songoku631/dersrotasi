...
historyPresenterCheck($presented['year'] === 2025, 'Eski 2026 etiketi istemciye 2025 olarak sunulmalı.');
historyPresenterCheck($presented['source_year'] === 2026, 'Kaynak yılı izlenebilir kalmalı.');
historyPresenterCheck($presented['rankings'] === ['2025' => 7395, '2024' => 5725, '2023' => 5039], 'Sıralamalar yıllara göre normalize edilmedi.');
...
historyPresenterCheck(!array_key_exists('ranking_2025', $presented), 'İç sorgu alias alanı yanıtta kalmamalı.');
